...
N -300 900 -160 900 {lab=vfb}
N -100 900 -80 900 {lab=#net1}
N -340 900 -300 900 {lab=vfb}
N -420 900 -420 920 {
lab=#net2}
N -420 980 -420 1020 {
lab=#net3}
N -420 900 -400 900 {lab=#net2}
N -420 1080 -420 1120 {lab=vssa}
N -520 1120 -420 1120 {
lab=vssa}
N -520 960 -520 1120 {lab=vssa}
N 240 980 240 1120 {lab=vssa}
N -700 860 -700 1120 {lab=vssa}
N -180 840 -180 1120 {lab=vssa}
N -420 1120 -180 1120 {
lab=vssa}
C {devices/vsource.sym} -700 830 0 0 {name=Vvdda value="'xvdda' ac 1"
...
C {devices/vsource.sym} -520 930 0 0 {name=Vvref value=xvref
format="@name @pinlist @value"}
C {devices/vsource.sym} -800 1060 0 0 {name=Vvssa value=0
format="@name @pinlist @value"}
C {devices/gnd.sym} -800 1110 0 0 {name=l1 lab=GND}
...
C {devices/lab_wire.sym} -800 1010 3 1 {name=p6 sig_type=std_logic lab=vssa

}
C {devices/lab_wire.sym} -480 1120 0 1 {name=p7 sig_type=std_logic lab=vssa
...
C {res.sym} -370 900 1 0 {name=R3
value="'xR2var' noisy=1"
footprint=1206
device=resistor
m=1
}
C {res.sym} -130 900 1 0 {name=R4
value="'xR1var' noisy=1"
footprint=1206
device=resistor
m=1
}
C {devices/vsource.sym} -420 950 0 0 {name=Vstep1 value="pwl (0 0 \{xtsim/2\} 0 \{\{xtsim/2\}+xtrf\} \{xstep_en*xstep*\{-1\}\})"
format="@name @pinlist @value"}
C {devices/vsource.sym} -420 1050 0 0 {name=Vvinn value=xvinn
format="@name @pinlist @value"}
