...
N -380 1000 -180 1000 {
lab=vssa}
N 80 780 80 800 {lab=vout}
N 80 780 240 780 {lab=vout}
N 240 780 240 920 {lab=vout}
N 80 1000 240 1000 {lab=vssa}
N 240 980 240 1000 {lab=vssa}
N 20 900 80 900 {lab=#net2}
N 80 860 80 900 {lab=#net2}
N -300 900 -80 900 {lab=vfb}
N 80 900 80 920 {lab=#net2}
...
C {res.sym} 80 950 0 0 {name=R1
value="'xR2var' noisy=1"
footprint=1206
device=resistor
m=1
}
C {res.sym} 80 830 0 0 {name=R2
