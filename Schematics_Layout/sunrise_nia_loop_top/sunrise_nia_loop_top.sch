...
N 60 0 120 -0 {lab=vout_Rg}
N 120 0 120 60 {lab=vout_Rg}
...
C {opin.sym} 120 60 1 0 {name=p2 lab=vout_Rg}
C {sunrise/sunrise_stg1_loop.sym} -20 -60 0 0 {name=xstg1_loop_nia_config}
